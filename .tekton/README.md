...
To modify the pipelines for `openvino_model_server` in the `rhoai-3.5-ea.2` release:
...
```bash
git commit -am "Update pipelinerun for openvino_model_server (rhoai-3.5-ea.2)"
